        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a
                    ...
                    href="#"
                    @click.stop="$emit('toggle', 'register')"
                >
                    Sign up here
                </a>
            </p>
                ...
                <div class="grid gap-y-4">
                    ...
                    <div>
                        <div class="flex justify-between items-center">
                            ...
                            <a
                                class="text-blue-600 decoration-2 hover:underline font-medium text-sm"
                                href="#"
                                @click.stop="$emit('toggle', 'forgot-password')"
                            >
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <!-- End Form Group -->
                    <Checkbox v-model="formData.remember_me" value="Remember me" />
