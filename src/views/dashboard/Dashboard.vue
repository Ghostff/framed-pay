<template>
  <!-- ========== HEADER ========== -->
    <header class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-1 lg:pl-64 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-row items-center justify-end gap-2">
                    ...
                    <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                        <button id="hs-dropdown-with-header" type="button"
                            ...
                            <IconPersonCircle class="w-4 h-4"/>
                        </button>
    ...
    <div class="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-gray-800 dark:border-gray-700">
        <div class="flex items-center py-2">
            ...
            <ol class="ml-3 flex items-center whitespace-nowrap min-w-0" aria-label="Breadcrumb">
                ...
                <li
                    class="text-sm font-semibold text-gray-800 truncate dark:text-gray-400 capitalize"
                    aria-current="page"
                >
                    {{ routeName }}
                </li>
    ...
    <div id="application-sidebar"
        ...
        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-0.5">
                ...
                <NavLink title="Integrations" :is-active="routeName == 'integrations'" color="purple" :icon="IconCircleNodes" :sub-menu="[
