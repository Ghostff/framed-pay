    ...
    <Form ref="formElement" @submit="save" @honey-pot="(v) => formData.confirm_email = v">
      ...
      <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
        ...
        <div class="sm:col-span-9">
          <div class="sm:flex">
            <Input v-model="formData.first_name" name="first_name" maxlength="255" required classes="rounded-tr-none rounded-br-none" size="md" />
            <Input v-model="formData.last_name" name="last_name" maxlength="255" required classes="rounded-tl-none rounded-bl-none -ml-px" size="md" />
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="sm:col-span-9">
          <Input v-model="formData.email" name="email" required type="email" size="md" minlength="4" maxlength="255" />
        </div>
        <!-- End Col -->
        ...
        <div class="sm:col-span-9">
          <div class="space-y-2">
            <Input v-model="formData.current_password" name="current_password" minlength="6" maxlength="255" type="password" size="md" placeholder="Enter current password" />
            <Input v-model="formData.new_password" name="new_password" minlength="6" maxlength="255" type="password" size="md" placeholder="Enter new password" />
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="sm:col-span-9">
          <div class="sm:flex relative">
              <Input
                  ...
                  @on:country-change="(c) => formData.country_code = c.code"
                  type="tel"
                  size="md"
                  name="phone"
                  class="w-full"
...
import {EditableUserInterface, UserInterface} from "@/models/user";
...
function save(): void {
  ...
  recaptchaRequest({ uri: 'user', data: formData.value, method: 'PUT' })
