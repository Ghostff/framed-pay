<template>
  <!-- BEGIN HERO SECTION -->
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-20">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
            <div class="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 dark:text-white sm:text-6xl xl:mb-8">
                    Payment Processing Made Easy
                </h1>
                <p class="pr-0 mb-8 text-base sm:text-lg xl:text-xl lg:pr-20">
                    Our unified iframe solution simplifies your checkout process and eliminates payment integration
                    hassles by allowing you to use a single stylable iframe for multiple payment processors.

                    <a class="ml-3 inline-flex items-center gap-x-2 text-sm font-semibold text-indigo-500 dark:text-indigo-600 hover:text-indigo-400" href="#">
                        See supported gateways
                        <FontArrowRight class="mt-1 transition ease-in-out" />
                    </a>
                </p>

                <Button size="xl" @click="$emit('on:signup')"><b>Signup Today!</b></Button>
                <!-- Integrates with section -->
                <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                    <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">Popular Integrations</p>
                    <div class="flex">
  ...
  <!-- Icon Blocks -->
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="grid sm:grid-cols-2 lg:grid-cols-2 items-center gap-4 xl:gap-6">
            <!-- Card -->
            <div class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]">
                <FontSignpostSplit class="flex-shrink-0 w-8 h-8 text-gray-800 mt-0.5 mr-6 text-indigo-500" />
                <div>
                    <div>
                        <h3 class="block font-bold text-gray-800 dark:text-white">Simplified Payment Integration</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            With our payment processor iframe consolidation service,
                            you can simplify your payment integration process by using the same code for every payment processor.
                            This means you don't have to worry about creating separate integrations for different payment methods,
                            making the payment process much more efficient.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Card -->
            <div class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]">
                <FontShieldShaded class="flex-shrink-0 w-8 h-8 text-gray-800 mt-0.5 mr-6 text-indigo-500" />
                <div>
                    <div>
                        <h3 class="block font-bold text-gray-800 dark:text-white">Enhanced Security</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            As a website owner, ensuring the security of your customers' payment information is of utmost importance.
                            By using our PCI compliant iframe, you can be confident that all payment transactions are secure
                            and that you're protecting your customers' sensitive data.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Card -->
            <div class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" >
                <FontEmojiHeartEyes class="flex-shrink-0 w-8 h-8 text-gray-800 mt-0.5 mr-6 text-indigo-500" />
                <div>
                    <div>
                        <h3 class="block font-bold text-gray-800 dark:text-white">Improved User Experience</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            With our payment processor iframe, your customers can enjoy a seamless and hassle-free payment experience.
                            By using a standardized payment process across all payment methods,
                            you can provide a more consistent and user-friendly experience for your customers.
                        </p>
                    </div>
            ...
            <!-- Card -->
            <div class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]">
                <FontGraphUp class="flex-shrink-0 w-8 h-8 text-gray-800 mt-0.5 mr-6 text-indigo-500" />
                <div>
                    <div>
                        <h3 class="block font-bold text-gray-800 dark:text-white">Increased Conversion Rates</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            By using our payment processor iframe, you can reduce payment
                            errors and make the payment process faster and more straightforward.
                            This can lead to increased conversion rates and more successful transactions,
                            ultimately helping you to grow your business.
                        </p>
                    </div>
                </div>
            </div>
  ...
  <!-- BEGIN FEATURES SECTION -->
    <div
            id="features"
            class="relative w-full px-8 py-10 border-t border-gray-200 dark:border-slate-800 md:py-16 lg:py-24 xl:py-30 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            <h1 class="px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 dark:text-white sm:mt-0 sm:px-0 sm:text-6xl">
                How it works
            </h1>
            <div class="mt-2 text-base font-black leading-tight text-center">
                Built and Designed with you in Mind
            </div>
            <div class="flex flex-col w-full mt-20 lg:flex-row">
                <div class="w-full max-w-md p-1 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-5 mr-5 rounded-lg">
                        <svg class="absolute w-full h-full text-gray-100 dark:text-slate-800 fill-current" viewBox="0 0 377 340"
                        ...
                        <h4 class="relative mt-2 text-lg font-bold text-center">Link Your Preferred Payment Gateway</h4>
                        <p class="relative mt-2 text-base text-center">
                            Once you're logged in, you will need to link your preferred payment gateway
                            to your account. This will ensure that you are able to receive payments
                            for the services you provide through our website.
                        </p>
                    </div>
                </div>

                <div class="w-full max-w-md p-1 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-10 mr-5 rounded-lg">
                        <svg class="absolute w-full h-full text-gray-100 dark:text-slate-800 fill-current" viewBox="0 0 358 372"
                             xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                        ...
                        <h4 class="relative mt-2 text-lg font-bold">Generate an Access Token</h4>
                        <p class="relative mt-2 text-base text-center">
                            After linking your payment gateway, we will generate an access token for you.
                            This token will be used to authenticate your account and allow you to access our services.
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full max-w-md p-1 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-10 mr-5 rounded-lg">
                        <svg class="absolute w-full h-full text-gray-100 dark:text-slate-800 fill-current" viewBox="0 0 378 410"
                             xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path
                        ...
                        <h4 class="relative mt-2 text-lg font-bold">Add an iFrame to Your Site</h4>
                        <p class="relative mt-2 text-base text-center">
                            Finally, you will need to add an iFrame to your site and include
                            the access token that was generated for you. This will enable you
                            to display our services on your site and receive payments from your customers.
                        </p>
                    </div>
                </div>
            </div>
  ...
  <!-- Pricing Section -->
    <div class="relative w-full px-8 py-10 border-t border-gray-200 dark:border-slate-800 md:py-16 lg:py-24 xl:py-30 xl:px-0">

        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h3 class="px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 dark:text-white sm:mt-0 sm:px-0 sm:text-6xl">
                Simple, Transparent plans
            </h3>
            <div class="mt-3 font-black leading-tight text-center">
...
import AllPlans from "@/components/payment/plans/AllPlans.vue";
import Button from "@/components/form/Button.vue";
import FontArrowRight from "@/components/icons/IconArrowRight.vue";
import FontSignpostSplit from "@/components/icons/IconSignpostSplit.vue";
import FontShieldShaded from "@/components/icons/IconShieldShaded.vue";
import FontGraphUp from "@/components/icons/IconGraphUp.vue";
import FontEmojiHeartEyes from "@/components/icons/IconEmojiHeartEyes.vue";
