...
onMounted(() => {
  ...
  const options = {
    ...
    dropdownClasses: 'mt-2 z-50 w-full max-h-[300px] space-y-0.5 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto dark:bg-slate-900 dark:border-gray-700',
    ...
    optionTemplate: '<div><div class="flex items-center"><div class="{:dynamic-cls} text-gray-800 dark:text-gray-200" data-title></div></div><div class="mt-1.5 text-sm text-gray-500" data-description></div></div>',
  ...
  options.optionTemplate = options.optionTemplate.replace('{:dynamic-cls}', props.hasDescription ? 'font-semibold' : '')
